...
const RECIPES_DATABASE = {
    ...
    lunch: [
        ...
        
        {
            ...
            ingredients: [
                ...
                "2 soft-boiled eggs",
                "½ cup cucumber, sliced",
                "3 tbsp coconut aminos or GF tamari",
                "2 tbsp sesame oil",
                "1 tbsp rice vinegar",
                "2 cloves garlic, minced",
                "1 tsp ginger, grated",
        ...
        
        {
            ...
            ingredients: [
                ...
                "2 tbsp coconut aminos or GF tamari",
                "1 tbsp coconut aminos (or GF fish sauce)",
                "1 tbsp lime juice",
            ...
            instructions: [
                ...
                "Add coconut aminos, coconut aminos (or GF fish sauce), lime juice, and coconut sugar",
    ...
    dinner: [
        ...
        
        {
            ...
            instructions: [
                ...
                "Stir in coconut aminos (or GF fish sauce) and lime juice",
        ...
        
        {
            ...
            ingredients: [
                ...
                "¼ cup white wine (or GF chicken broth)",
                "2 lemons (juice and zest)",
                "¼ cup fresh parsley",
                "Red pepper flakes (optional)",
                "Salt and pepper"
        ...
        
        {
            ...
            ingredients: [
                ...
                "4 cups chicken or GF vegetable broth",
                "1 onion, diced",
            ...
            instructions: [
                ...
                "Add beans, GF broth, cumin, and oregano",
        ...
        
        {
            ...
            ingredients: [
                ...
                "½ lb white fish, cubed",
                "1 can (14 oz) coconut milk",
                "2 cups fish or GF vegetable broth",
                "1 yuca, peeled and cubed (portion controlled)",
                "1 plantain, sliced",
                "1 bell pepper, diced",
                "1 onion, diced",
            ...
            instructions: [
                ...
                "Add coconut milk, GF broth, yuca, and plantain",
                "Simmer 25-30 minutes until yuca is tender",
        ...
        
        {
            ...
            ingredients: [
                ...
                "3 tbsp coconut aminos (or GF fish sauce)",
                "2 tbsp lime juice",
                "Fresh cilantro",
                "1 tbsp coconut oil"
            ],
        ...
        
        {
            ...
            gregMacros: { protein: "38g", carbs: "75g", fat: "25g", calories: 600 },
            reynaMacros: { protein: "23g", carbs: "45g", fat: "15g", calories: 360 }
        }
    ],
    ...
    snacks: [
        ...
        // === BEVERAGES ===
        {
            ...
            hondurasNotes: "Popular street drink. Rice is cheap and available everywhere.",
            gregMacros: { protein: "2g", carbs: "18g", fat: "3g", calories: 90 },
            reynaMacros: { protein: "2g", carbs: "14g", fat: "2g", calories: 73 }
        },
        
        {
            ...
            hondurasNotes: "Jamaica flowers available in all markets. Very popular refreshing drink.",
            gregMacros: { protein: "0g", carbs: "2g", fat: "0g", calories: 8 },
            reynaMacros: { protein: "0g", carbs: "1g", fat: "0g", calories: 6 }
        },
        
        {
            ...
            hondurasNotes: "Tamarind widely available. Sweet-tart flavor, very refreshing.",
            gregMacros: { protein: "1g", carbs: "8g", fat: "0g", calories: 32 },
            reynaMacros: { protein: "0g", carbs: "6g", fat: "0g", calories: 26 }
        },
        
        {
            ...
            gregMacros: { protein: "1g", carbs: "4g", fat: "8g", calories: 100 },
            reynaMacros: { protein: "1g", carbs: "4g", fat: "6g", calories: 82 }
        },
        
        {
            ...
            instructions: [
                "In saucepan, bring water to boil with cardamom, cinnamon, cloves, and ginger",
                "Simmer spices 5 minutes to infuse",
                "Add tea bags, steep 3-4 minutes",
                "Add almond milk and heat through (don't boil)",
                "Add stevia to taste (traditional uses 2-3 tbsp sugar)",
                "Strain into cups",
                "Serve hot - aromatic and warming!",
                "Note: Adjust spices to preference - add black pepper for extra kick!"
            ],
            gregMacros: { protein: "1g", carbs: "3g", fat: "2g", calories: 25 },
            reynaMacros: { protein: "1g", carbs: "3g", fat: "2g", calories: 25 }
        },
        
        {
            id: "S022",
            name: "Mango Lassi (Sugar-Free)",
            spicy: false,
            prepTime: "5 min",
            cookTime: "0 min",
            servings: "2 servings",
            ...
            instructions: [
                "Add yogurt, mango, almond milk, and cardamom to blender",
                "Add stevia to taste (traditional uses 2-3 tbsp sugar)",
                "Add 4-5 ice cubes",
                ...
                "Note: Can substitute mango with berries for lower carbs!"
            ],
            gregMacros: { protein: "12g", carbs: "15g", fat: "8g", calories: 165 },
            reynaMacros: { protein: "12g", carbs: "15g", fat: "8g", calories: 165 }
        },
        
        {
            ...
            ingredients: [
                "4 cups water",
                "2 tbsp green tea (or 4 green tea bags)",
                "Large handful fresh mint leaves (about 1 cup)",
                "Stevia to taste (replaces sugar)",
                "Lemon slices (optional)"
            ],
            instructions: [
                "Bring water to boil, let cool 1 minute (don't use boiling water on green tea)",
                "Add green tea, steep 3 minutes",
                "Add fresh mint leaves, steep 2 more minutes",
                "Add stevia to taste (traditional uses ¼ cup sugar)",
                "Strain into teapot or pitcher",
                "Serve hot in small glasses",
                "Garnish with mint sprig and lemon if desired",
                "Note: Traditionally poured from height for aeration - creates bubbles!"
            ],
            gregMacros: { protein: "0g", carbs: "1g", fat: "0g", calories: 5 },
            reynaMacros: { protein: "0g", carbs: "1g", fat: "0g", calories: 5 }
        },
        
        {
            id: "S024",
            name: "Tibetan Butter Tea (Po Cha)",
            spicy: false,
            prepTime: "5 min",
            cookTime: "10 min",
            servings: "2 servings",
            ...
            ingredients: [
                "2 cups water",
                "2 tsp black tea (Pu-erh tea traditional, but any strong black tea works)",
            ...
            instructions: [
                "Bring water to boil, add tea",
                "Simmer 5-7 minutes for strong brew",
                "Strain tea into blender",
                "Add butter, salt, and cream/milk if using",
                "Blend on high 30 seconds until frothy",
                "Pour into cups and serve hot",
                "Note: Savory, not sweet! High-fat, perfect for cold weather",
                "Tibetan altitude adaptation - provides energy and warmth!"
            ],
            hondurasNotes: "Not traditional in Honduras but perfect for mountain mornings!",
            gregMacros: { protein: "1g", carbs: "1g", fat: "14g", calories: 130 },
            reynaMacros: { protein: "1g", carbs: "1g", fat: "14g", calories: 130 }
        }
        ...
        
{
        ...
        
        {
            ...
            cuisine: "Asian",
            ingredients: [
                "½ cup coconut aminos or GF tamari",
                "2 tbsp sesame oil",
                "2 tbsp rice vinegar",
                "2 cloves garlic, minced",
                "1 tbsp ginger, grated",
